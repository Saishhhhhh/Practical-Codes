...
public:
    ...
    void addElement() {
        ...
        // Check if element already exists in the chosen set
        if (setChoice == 'A' || setChoice == 'a') {
            ...
            if (!elementExists) {
                ...
                cout << "Element " << element << " already exists in Set A" << endl;
            }
        }
            ...
            if (!elementExists) {
                ...
                cout << "Element " << element << " already exists in Set B" << endl;
            }
        }
        else {
    ...
    void isSubset() {
        ...
        // Check if every element of A is in B    // 5, 3, 2    // 2,3,4
        for (auto itA = setA.begin(); itA != setA.end(); itA++) {
            bool found = false;
            for (auto itB = setB.begin(); itB != setB.end(); itB++) {
                if (*itA == *itB) {
        ...
        if (aSubsetB && bSubsetA)
            cout << "Set A and Set B are equal (each is a subset of the other)." << endl;
        else if (aSubsetB)
            cout << "Set A is a subset of Set B." << endl;
        else if (bSubsetA)
            cout << "Set B is a subset of Set A." << endl;
        else
            cout << "Neither set is a subset of the other." << endl;
    }
};
