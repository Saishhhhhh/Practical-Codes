// Aim: Write a C++ program to draw a 2-D object and perform the following basic transformations:
...
int main() 
{
    ...
    switch(ch) 
    {
        ...
        case 3:
            ...
            cin >> deg;
            theta = deg * (3.14 / 180);  // Converting to radians
            b[0][0] = cos(theta);
            b[0][1] = sin(theta);
            b[1][0] = -sin(theta);
            b[1][1] = cos(theta);
...
// 100 100
// 0 100
// Enter value for tx and ty: 50 50
// For Scaling
